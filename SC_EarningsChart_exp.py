...
main_plt = plt.subplot2grid((4, 3), (0, 0), rowspan=2,colspan=3)
notes_plt = plt.subplot2grid((4, 3), (3, 0), rowspan=1,colspan=3)

# main_plt = fig.add_subplot(411)
# notes_plt = fig.add_subplot(414)
