...
waveform_json = """
{
 ...
 # {"name": "clk_other", "wave": "p..........", "period": 2},
   {"name": "CLK", "wave": "P.............", "period": 1},
    ...
    # PWQ write, PW S/M
    {"name": "pwQ_wren",                     "wave": "010."},
    {"name": "pw_sm", "wave": "6...22222.|.26", 
                          data:["Idle", "Start", "L4", "L4_PEND","L3","L3_PEND","Done","Idle"], },

    # LSU LDQ Write, PW request to LSU, PTE back
    {"name": "pwldQ_wren",                   "wave": "0...10......"},
    {"name": "pwc_lookup",                   "wave": "0....1010...", "node":".....a.d...."},
    {"name": "pwc_early_hit",                "wave": "0....10.....", "node":".....b.e...."},
    {"name": "pwc_hit",                      "wave": "0.....10...."},
    {"name": "mmu_ld_req_vld",               "wave": "0......10...", "node":".....c.f...."},
    {},
...
output_filename = r"C:\Sundeep\Akeana\MMU-Docs\Timing Diagrams\PWC_Hit.svg"
