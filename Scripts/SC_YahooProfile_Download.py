...
for ticker_raw in ticker_list:
  ...
  try:
    ...
    profile_data = yahoo_financials.get_stock_quote_type_data()
    print ("Thing returned is ", profile_data)
    profile_data = yahoo_financials.get_key_statistics_data()
    print ("Thing returned is ", profile_data)
    profile_data = yahoo_financials.get_summary_data()
    print ("Thing returned is ", profile_data)
    profile_data = yahoo_financials.get_stock_earnings_data()
    print ("Thing returned is ", profile_data)
    sys.exit(1)
